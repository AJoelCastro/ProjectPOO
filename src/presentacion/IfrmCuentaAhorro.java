...
public class IfrmCuentaAhorro extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnSaldo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/3844476-eye-see-show-view-watch_110339.png"))); // NOI18N
        btnSaldo.setText("Mostrar saldo");
    ...
    private void btnSaldoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaldoActionPerformed
        if (saldoVisible) {
            ...
            if (cuentaActual != null) {
                ...
                txtSaldo.setText(moneda + " " + String.format("%.2f", cuentaActual.getSaldoCuenta())); // Muestra el saldo
            } else {
                txtSaldo.setText("Saldo no disponible"); // Mensaje alternativo si no hay cuenta activa
            }
    ...
    private void btnDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDepositoActionPerformed
        ...
        try {
            ...
            if (listaMovimientos.registrarDeposito(cuentaActual, monto)) {
                actualizarSaldo();
                btnMovimientosActionPerformed(null); // Actualizar la tabla de movimientos
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this,
                "Por favor ingrese un monto válido",
    ...
    private void btnTransferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTransferenciaActionPerformed
        ...
        // Panel para ingresar datos de transferencia
